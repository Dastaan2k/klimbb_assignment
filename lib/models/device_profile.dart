...
class DeviceProfile {
  ...
  DeviceProfile copyWith({String? name, double? latitude, double? longitude, FlexScheme? theme, double? fontSizeMultiplier}) {
    return DeviceProfile(name: name ?? this.name, latitude: latitude ?? this.latitude, longitude: longitude ?? this.longitude, theme: theme ?? this.theme, fontSizeMultiplier: fontSizeMultiplier ?? this.fontSizeMultiplier)..id=id;
  }
